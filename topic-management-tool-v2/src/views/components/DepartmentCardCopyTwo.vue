            ...
            >
              ...
              <td>
                <div class="text-center">
                  <a :href="resultItem.docxReport" @click.prevent="downloadFile(resultItem.docxReport)">
              ...
              <td>
                <div class="text-center">
                  <a :href="resultItem.sourceCode" @click.prevent="downloadFile(resultItem.sourceCode)">
...
,
  ...
  async created() {
    // const departments = await departmentService.get({});
    // this.departments = departments.data;
    const results = await resultService.getKTMT()
