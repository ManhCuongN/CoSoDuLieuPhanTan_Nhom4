    ...
    <div class="shadow-lg card">
      <div class="pt-3 pb-0 bg-transparent card-header">
        <div class="float-start">
          <h5 class="mt-3 mb-0">Tinh chỉnh giao diện</h5>
          <p>Chọn bảng điều khiển.</p>
        </div>
      ...
      <div class="pt-0 card-body pt-sm-3">
        <!-- Sidebar Backgrounds -->
        <div>
          <h6 class="mb-0">Màu sắc thanh menu</h6>
        </div>
        ...
        <!-- Sidenav Type -->
        <div class="mt-3">
          <h6 class="mb-0">Loại Menu</h6>
          <p class="text-sm">Chọn 1 loại menu.</p>
        </div>
        <div class="d-flex">
          <button
            id="btn-dark"
        ...
        <p class="text-sm d-xl-none d-block mt-2">
          Bạn chỉ có thể chọn loại menu trong màn hình desktop.
        </p>
